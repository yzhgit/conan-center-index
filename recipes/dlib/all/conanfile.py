...
class DlibConan(ConanFile):
    ...
    def _configure_cmake(self):
        ...
        cmake.definitions["DLIB_USE_BLAS"] = False    # FIXME: all the logic behind is not sufficiently under control
        cmake.definitions["DLIB_USE_LAPACK"] = False  # FIXME: all the logic behind is not sufficiently under control
